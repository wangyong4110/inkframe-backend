...
完整的产品文档和前端设计请参阅 **[PRODUCT_DOCUMENTATION.md](./PRODUCT_DOCUMENTATION.md)**
...
| 环节 | 人工介入点 | 说明 |
|------|-----------|------|
| **世界观** | 修改设定、添加元素 | 世界观创建和调整 |
| **角色** | 修改外貌、调整关系 | 角色设计和管理 |
| **大纲** | 修改章节、调整顺序 | 大纲规划和调整 |
| **章节** | 编辑内容、检查一致性 | 章节创作和审核 |
| **质量检查** | 审阅问题、选择修复 | 问题检测和修复 |
| **角色视觉** | 确认形象、调整细节 | 角色视觉设计 |
| **场景视觉** | 完善场景、调整光照 | 场景视觉设计 |
| **分镜** | 调整镜头、修改时长 | 分镜规划和编辑 |
| **视频生成** | 调整帧、配置音频 | 视频生成和导出 |
| **模型选择** | 配置映射、设置策略 | 模型管理和选择 |
