...
func TestKlingTTSProvider_AudioGenerate_Validation(t *testing.T) {
	...
	t.Run("empty text errors", func(t *testing.T) {
		_, err := p.AudioGenerate(context.Background(), &AudioGenerateRequest{Voice: "zh_female_story"})
		if err == nil {
...
func TestKlingTTSProvider_AudioGenerate_TaskFailed(t *testing.T) {
	...
	_, err := p.AudioGenerate(ctx, &AudioGenerateRequest{Text: "hello", Voice: "zh_female_story"})
	if err == nil {
