...
func (p *KlingProvider) generate3xTurbo(ctx context.Context, req *ai.VideoGenerateRequest, model string) (*ai.VideoTask, error) {
...
func (p *KlingProvider) GenerateVideo(ctx context.Context, req *ai.VideoGenerateRequest) (*ai.VideoTask, error) {
...
func (p *KlingProvider) GetVideoStatus(ctx context.Context, taskID string) (*ai.VideoTaskStatus, error) {
