...
func (p *KlingLipSyncProvider) GenerateLipSync(ctx context.Context, req *ai.LipSyncRequest) (*ai.LipSyncTask, error) {
	if req.ImageURL == "" {
...
func (p *KlingLipSyncProvider) GetLipSyncStatus(ctx context.Context, taskID string) (*ai.LipSyncTaskStatus, error) {
...
var _ ai.LipSyncProvider = (*KlingLipSyncProvider)(nil)
