...
func TestQianwenProvider_Generate_Qwen3DisablesThinking(t *testing.T) {
	...
	p := NewQianwenProvider("key", server.URL, "", 0)
	_, err := p.Generate(context.Background(), &GenerateRequest{Model: "qwen3-32b", Messages: []ChatMessage{{Role: "user", Content: "hi"}}})
	if err != nil {
		t.Fatalf("Generate() error: %v", err)
	}
...
func TestQianwenProvider_ImageGenerate_CompatSyncPath(t *testing.T) {
	...
	p := NewQianwenProvider("key", server.URL, "", 0)
	resp, err := p.ImageGenerate(context.Background(), &ImageGenerateRequest{Model: "wanx-v1", Prompt: "a cat"})
	if err != nil {
...
func TestQianwenProvider_ImageGenerate_CompatError(t *testing.T) {
	...
	p := NewQianwenProvider("key", server.URL, "", 0)
	resp, err := p.ImageGenerate(context.Background(), &ImageGenerateRequest{Model: "wanx-v1", Prompt: "x"})
	if err != nil {
...
func TestQianwenProvider_ImageGenerate_AsyncSubmitAndPoll(t *testing.T) {
	...
	resp, err := p.ImageGenerate(context.Background(), &ImageGenerateRequest{Model: "wanx2.1-t2i-turbo", Prompt: "a dog", Size: "1024x1024"})
	if err != nil {
		t.Fatalf("ImageGenerate() error: %v", err)
	}
...
func TestQianwenProvider_ImageGenerate_AsyncFailed(t *testing.T) {
	...
	p := NewQianwenProvider("key", server.URL+"/compatible-mode/v1", "", 0)
	resp, err := p.ImageGenerate(context.Background(), &ImageGenerateRequest{Model: "wanx2.1-t2i-turbo", Prompt: "x"})
	if err != nil {
		t.Fatalf("ImageGenerate() error: %v", err)
	}
...
func TestQianwenProvider_AudioGenerate_CosyVoice(t *testing.T) {
	...
	resp, err := p.AudioGenerate(context.Background(), &AudioGenerateRequest{Text: "hello", Voice: "longxiaochun"})
	if err != nil {
...
var _ AIProvider = (*QianwenProvider)(nil)
