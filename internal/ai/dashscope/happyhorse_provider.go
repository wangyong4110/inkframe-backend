...
func (p *HappyHorseProvider) GenerateVideo(ctx context.Context, req *ai.VideoGenerateRequest) (*ai.VideoTask, error) {
...
func (p *HappyHorseProvider) GetVideoStatus(ctx context.Context, taskID string) (*ai.VideoTaskStatus, error) {
