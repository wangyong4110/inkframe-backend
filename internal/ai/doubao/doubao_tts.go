...
func (p *DoubaoSpeechProvider) AudioGenerate(ctx context.Context, req *ai.AudioGenerateRequest) (*ai.AudioResponse, error) {
	start := time.Now()
...
func (p *DoubaoSpeechProvider) buildDoubaoSpeechBody(req *ai.AudioGenerateRequest, speaker, resourceID string) ([]byte, error) {
...
func (p *DoubaoSpeechV1Provider) AudioGenerate(ctx context.Context, req *ai.AudioGenerateRequest) (*ai.AudioResponse, error) {
	start := time.Now()
