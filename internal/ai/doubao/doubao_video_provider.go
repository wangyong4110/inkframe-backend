...
func init() {
	...
	ai.RegisterVideoEngineTraits(ProviderNameDoubao, traits)
	ai.RegisterVideoEngineTraits(ProviderNameSeedance, traits)
}
...
func (p *DoubaoVideoProvider) GenerateVideo(ctx context.Context, req *ai.VideoGenerateRequest) (*ai.VideoTask, error) {
	model := req.Model
	if model == "" {
...
func (p *DoubaoVideoProvider) GetVideoStatus(ctx context.Context, taskID string) (*ai.VideoTaskStatus, error) {
