...
func TestDoubaoSpeechProvider_buildDoubaoSpeechBody(t *testing.T) {
	...
	t.Run("basic fields", func(t *testing.T) {
		body, err := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi"}, "speaker1", "seed-tts-2.0")
		if err != nil {
	...
	t.Run("emotion selects expressive submodel and context_texts", func(t *testing.T) {
		body, err := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi", Emotion: "happy"}, "speaker1", "seed-tts-2.0")
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		var parsed map[string]interface{}
	...
	t.Run("doubao-character-tts skips model field", func(t *testing.T) {
		body, err := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi", Emotion: "happy"}, "speaker1", "doubao-character-tts")
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		var parsed map[string]interface{}
	...
	t.Run("speed maps to speech_rate clamped range", func(t *testing.T) {
		body, _ := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi", Speed: 3.0}, "speaker1", "seed-tts-2.0")
		var parsed map[string]interface{}
		json.Unmarshal(body, &parsed) //nolint:errcheck
		reqParams := parsed["req_params"].(map[string]interface{})
	...
	t.Run("pitch clamped to -12..12", func(t *testing.T) {
		body, _ := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi", Pitch: 50}, "speaker1", "seed-tts-2.0")
		var parsed map[string]interface{}
		json.Unmarshal(body, &parsed) //nolint:errcheck
		reqParams := parsed["req_params"].(map[string]interface{})
	...
	t.Run("additions fields marshaled to JSON string", func(t *testing.T) {
		body, _ := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{
	...
	t.Run("section_id passthrough", func(t *testing.T) {
		body, _ := p.buildDoubaoSpeechBody(&ai.AudioGenerateRequest{Text: "hi", SectionID: "sec-1"}, "speaker1", "seed-tts-2.0")
		var parsed map[string]interface{}
		json.Unmarshal(body, &parsed) //nolint:errcheck
		reqParams := parsed["req_params"].(map[string]interface{})
