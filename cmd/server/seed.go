...
func seedProviderVoices(db *gorm.DB) {
	...
	data := []providerVoices{
		...
		{"doubao-speech-v1", []voiceData{
			{"zh_female_vv_uranus_bigtts", "Vivi 2.0", "female", "adult", 0.92},
			{"zh_female_xiaohe_uranus_bigtts", "小何 2.0", "female", "adult", 0.91},
			{"zh_male_m191_uranus_bigtts", "云舟 2.0", "male", "adult", 0.91},
			{"zh_male_taocheng_uranus_bigtts", "小天 2.0", "male", "adult", 0.91},
			{"zh_male_liufei_uranus_bigtts", "刘飞 2.0", "male", "adult", 0.90},
			{"zh_female_sophie_uranus_bigtts", "魅力苏菲 2.0", "female", "adult", 0.90},
			{"zh_female_qingxinnvsheng_uranus_bigtts", "清新女声 2.0", "female", "adult", 0.90},
			{"zh_female_tianmeixiaoyuan_uranus_bigtts", "甜美小源 2.0", "female", "adult", 0.90},
			{"zh_female_tianmeitaozi_uranus_bigtts", "甜美桃子 2.0", "female", "adult", 0.90},
			{"zh_female_shuangkuaisisi_uranus_bigtts", "爽快思思 2.0", "female", "adult", 0.90},
			{"zh_female_linjianvhai_uranus_bigtts", "邻家女孩 2.0", "female", "adult", 0.90},
			{"zh_male_shaonianzixin_uranus_bigtts", "少年梓辛 2.0", "male", "teen", 0.90},
			{"zh_female_meilinvyou_uranus_bigtts", "魅力女友 2.0", "female", "adult", 0.90},
		...
		{"aliyun-tts", []voiceData{
			...
			{"longfei", "龙飞（男/沉稳自信）", "male", "adult", 0.91},
			{"longjielidou", "龙姐励豆（女/温暖励志）", "female", "adult", 0.91},
			{"longmiaomiao", "龙淼淼（女/儿童活泼）", "female", "child", 0.90},
			{"longshu", "龙叔（男/叙述沉稳）", "male", "adult", 0.92},
			{"longwan", "龙婉（女/甜美温柔）", "female", "adult", 0.91},
			{"longcheng", "龙橙（男/清晰专业）", "male", "adult", 0.91},
			{"longhua", "龙华（男/成熟稳重）", "male", "adult", 0.91},
			{"longxiang", "龙祥（男/磁性低沉）", "male", "adult", 0.91},
			{"loongbella", "贝拉（英文女声）", "female", "adult", 0.91},
			{"loongbobby", "鲍比（英文男声）", "male", "adult", 0.91},
			{"longanyang", "龙安洋（男/阳光社交，v3）", "male", "adult", 0.94},
			{"longanhuan_v3", "龙安欢（女/欢脱元气，v3）", "female", "adult", 0.94},
			{"longhuhu_v3", "龙呼呼（女童/天真烂漫，v3）", "female", "child", 0.93},
			{"longxiaochun_v3", "龙小淳（女/知性语音助手，v3）", "female", "adult", 0.93},
			{"longxiaoxia_v3", "龙小夏（女/沉稳权威，v3）", "female", "adult", 0.93},
			{"longyumi_v3", "YUMI（女/正经青年，v3）", "female", "adult", 0.93},
			{"longanwen_v3", "龙安温（女/优雅知性，v3）", "female", "adult", 0.92},
			{"longanyun_v3", "龙安昀（男/居家暖男，v3）", "male", "adult", 0.92},
			{"longsanshu_v3", "龙三叔（男/沉稳有声书，v3）", "male", "adult", 0.93},
			{"longmiao_v3", "龙妙（女/抑扬顿挫有声书，v3）", "female", "adult", 0.93},
			{"longanran_v3", "龙安燃（女/活泼直播带货，v3）", "female", "adult", 0.92},
			{"longshuo_v3", "龙硕（男/干练新闻播报，v3）", "male", "adult", 0.93},
			{"longshu_v3", "龙书（男/沉稳新闻播报，v3）", "male", "adult", 0.93},
		...
		{"qwen-tts", []voiceData{
			...
			{"Bunny", "Bunny 小兔（女童/活泼天真）", "female", "child", 0.91},
			{"Neil", "Neil 乃尔（男/成熟稳重）", "male", "adult", 0.91},
			{"Elias", "Elias 伊莱亚斯（女/温婉）", "female", "adult", 0.91},
			{"Arthur", "Arthur 亚瑟（男/老者睿智）", "male", "elder", 0.91},
			{"Nini", "Nini 倪倪（女/活泼少女）", "female", "teen", 0.91},
			{"Seren", "Seren 塞伦（女/优雅）", "female", "adult", 0.91},
			{"Pip", "Pip 小皮（男童/机灵）", "male", "child", 0.91},
			{"Stella", "Stella 斯黛拉（女/活力少女）", "female", "teen", 0.91},
			{"Jennifer", "Jennifer 詹妮弗（女/电影质感美语）", "female", "adult", 0.92},
			{"Ryan", "Ryan 甜茶（男/戏感炸裂）", "male", "teen", 0.91},
			{"Katerina", "Katerina 卡捷琳娜（女/御姐）", "female", "adult", 0.91},
			{"Aiden", "Aiden 艾登（男/美语大男孩）", "male", "adult", 0.91},
			{"Bodega", "Bodega 波德加（男/拉丁风情）", "male", "adult", 0.90},
